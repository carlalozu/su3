...
// static inline void fsu3matxsu3vec(su3_vec_field *restrict res, const su3_mat_field *restrict u, const su3_vec_field *restrict v, const size_t i)
// {
...
//  */
// #pragma omp declare target
// static inline void fsu3matxsu3mat(su3_mat_field *restrict res, const su3_mat_field *restrict u, const su3_mat_field *restrict v, const size_t i)
// {
//     // if (res == u || res == v || u == v)
//     // {
//     //     fprintf(stderr,
...
// 
// #pragma omp declare target
// static inline void fsu3mattrace(complexv *res, const su3_mat_field *ufield, const size_t i)
// {
